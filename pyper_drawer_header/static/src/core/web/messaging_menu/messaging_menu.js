...
export class drawerHeaderMessagingMenu extends Component {
    static components = { Dropdown, NotificationItem, ImStatus };
    static props = [];
    static template = "pyper_drawer_header.MessagingMenu";
...
registry
    ...
    .add("pyper_drawer_header.drawerHeaderMessagingMenu", { Component: drawerHeaderMessagingMenu }, { sequence: 2 });
