...
class AccountFiscalYear(models.Model):
    ...
    def cron_auto_create(self):
        ...
        for company in companies:
            last_fiscal_year = self.search([('company_id', '=', company.id)], order='date_to desc', limit=1)

            if last_fiscal_year and last_fiscal_year.date_to < datetime.now().date() + relativedelta(days=1):
    ...
    def _prepare_next_fiscal_year(self):
        ...
        # - 'FY 2018' will be replaced by 'FY 2019'
        # - 'FY 2018-2019' will be replaced by 'FY 2019-2020'
        ...
        if self.search([('name', '=', new_name), ('company_id', "=", self.company_id.id)]):
